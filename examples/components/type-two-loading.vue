    ...
    <!--
     ...
     <div class="content" v-if="index==2">
       ...
       <section class="explain">
         <p>说明:</p>
         <p>可通过var loading = new Loading({type:'type-two'});loading.open()来调用</p>
     ...
     <!--
      ...
      <div class="content" v-if="index==3">
        ...
        <type-two-loading title="加载中.." v-show="show"></type-two-loading>
        <section class="explain">
          <p>说明:</p>
          <p>组件名称: type-two-loading</p>
...
export default {
  ...
  data(){
    return {
      ...
      show: false,
      code: '',
      css: 'https://raw.githubusercontent.com/greatWeber/loadings/master/lib/style/type-two-loading.css',
      less: 'https://raw.githubusercontent.com/greatWeber/loadings/master/packages/assets/style/type-two-loading.less',
    }
  },
  mounted(){
  ...
  methods: {
    ...
    openLoad(){
      this.$loading.open('加载中.....','type-two');
    },
    closeLoad(){
      this.$loading.close();
    }
...
<style lang="less">
@import '~@/assets/style/type-two-loading.less';
